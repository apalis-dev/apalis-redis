...
-- ARGV = repeating groups of: task_id, timestamp, result_data, status, attempt
...
local num_tasks = #ARGV / args_per_task
local acked = 0

for i = 0, num_tasks - 1 do
    local base = i * args_per_task
    ...
    redis.call('SREM', inflight_set, task_id)
